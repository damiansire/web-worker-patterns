...
import { MANIFEST as M05 } from './05-error-handling/manifest';
import { MANIFEST as M06 } from './06-lifecycle-termination/manifest';
import { MANIFEST as M07 } from './07-transferable-objects/manifest';
