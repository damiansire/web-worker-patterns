...
@Component({
  ...
  providers: [BRUTALIST_PROVIDERS, ExampleLayoutController],
  template: `
    <section class="b-ex">
              ...
              <brutalist-card title="Costo de clonar">
                ...
                <div class="b-send">
                  ...
                  @if (cloneMeasurements().length && !cloneRunning()) {
                    <brutalist-button (pressed)="resetClone()">Reset</brutalist-button>
                  }
                </div>
  ...
  styles: [
    `
      ...
      /* ── offscreen-canvas (ej. 14): dos relojes worker vs main ── */
      .b-oc-ctl {
        display: flex;
        gap: 12px;
        flex-wrap: wrap;
