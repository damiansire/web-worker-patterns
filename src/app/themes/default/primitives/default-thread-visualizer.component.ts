...
/**
 * ThreadVisualizer del theme `default`: un carril por hilo, barras rectas y
 * neutras. Lee solo tokens semánticos.
 */
@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'default-thread-visualizer',
  imports: [DecimalPipe],
  template: `
    <div class="e-viz">
...
export class DefaultThreadVisualizer implements ThreadVisualizerContract {
